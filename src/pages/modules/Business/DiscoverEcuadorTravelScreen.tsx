...
const DiscoverEcuadorTravelScreen: React.FC = () => {
  const subtitle =
    'Cada pabellón de Ecuador Travel ha sido diseñado para sumergir a los visitantes en la riqueza y diversidad de as cuatro regiones del país.';
  return (
    <body className="grid grid-cols-1 space-y-8 mb-8">
      <ImageWithText
        imageUrl={crabImage}
        altText="Imagen de fondo"
        text="Propuesta Expositiva"
        subtitle={subtitle}
      />
